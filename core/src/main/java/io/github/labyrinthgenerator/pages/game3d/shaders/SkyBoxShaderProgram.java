...
public class SkyBoxShaderProgram implements Disposable {
    ...
    public SkyBoxShaderProgram(Pixmap positiveX, Pixmap negativeX, Pixmap positiveY, Pixmap negativeY, Pixmap positiveZ, Pixmap negativeZ) {
    ...
    public SkyBoxShaderProgram(FileHandle positiveX, FileHandle negativeX, FileHandle positiveY, FileHandle negativeY, FileHandle positiveZ, FileHandle negativeZ) {
    ...
    public SkyBoxShaderProgram(Pixmap cubemap) {
